...
namespace QuickStart.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var company = new Company {Id = Guid.NewGuid(), Name = Input.Company};
                await _appplicationDbContext.Companies.AddAsync(company);

                var user = new ApplicationUser
                {
                    UserName = Input.Email, Email = Input.Email, FirstName = Input.FirstName, LastName = Input.LastName,
                    CompanyId = company.Id, Roles = new List<ApplicationUserRole>
                    {
                        new ApplicationUserRole
                        {
                            RoleId = "acd59a30-5020-4c7d-8421-82e5855bf232"
                        }
                    }
                };
